...
| [`paperclip-task-coordinator`](skills/paperclip-task-coordinator/SKILL.md) | 定期拉取未完成任务，校正状态与依赖，并拉起下一批可执行任务 |
...
Use $paperclip-task-coordinator to inspect unfinished work and wake the next executable tasks.
```
